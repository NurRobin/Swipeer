  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-white p-6 rounded-lg auto-shadow">
        <h2 className="text-2xl font-semibold mb-4 text-center text-[var(--primary-color)]">Generate invite link</h2>
        <div className="flex flex-col items-center">
          <input
            ...
            className={`mb-4 py-2 px-4 border rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--primary-color)] text-black ${isUnlimited ? 'border-gray-300 bg-gray-200 text-gray-500 cursor-not-allowed' : 'border-gray-700'}`}
        ...
        <div className="flex justify-center">
          ...
          <button
            className={`py-2 px-4 font-semibold rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 ${isConfirmDisabled ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-[var(--primary-color)] hover:brightness-90 focus:ring-[var(--primary-color)]'}`}
