    ...
    <header className="bg-[var(--primary-color)] text-white p-4 md:p-6 rounded-lg shadow-md flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="bg-[var(--primary-color)] flex space-x-4">
        <Link href="/group/create" className='rounded-md shadow hover:bg-gray-100 transition'>
          <button className="bg-white text-[var(--primary-color)] px-4 py-2 rounded-md shadow hover:bg-gray-100 transition">
            + Create Group
          </button>
        </Link>
        <Link href="/survey/create" className='rounded-md shadow hover:bg-gray-100 transition'>
          <button className="bg-white text-[var(--primary-color)] px-4 py-2 rounded-md shadow hover:bg-gray-100 transition">
            + Create Survey
          </button>
        </Link>
        <Link href="/dashboard" className='rounded-md shadow hover:bg-gray-100 transition'>
          <button className="bg-white text-[var(--primary-color)] px-4 py-2 rounded-md shadow hover:bg-gray-100 transition">
            View Profile
          </button>
        </Link>
